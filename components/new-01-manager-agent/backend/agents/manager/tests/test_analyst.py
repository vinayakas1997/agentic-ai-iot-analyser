...
class TestHandleConfirm:
    ...
    def test_confirm_n_selects_proposal(self):
        ...
        proposals = [
            {"id": 1, "title": "Cost Analysis", "aims": ["average cost by fruit"], "what_you_might_see": "Cost data"},
            {"id": 2, "title": "Sales Report", "aims": ["sales by region"], "what_you_might_see": "Sales data"},
        ]
        ...
        assert len(result["analysis_proposals"]) == 1
    ...
    def test_confirm_n_selects_second_proposal(self):
        ...
        proposals = [
            {"id": 1, "title": "Cost", "aims": ["cost"], "what_you_might_see": ""},
            {"id": 2, "title": "Sales", "aims": ["sales"], "what_you_might_see": ""},
        ]
        state = self.make_state(analysis_proposals=proposals)
        session_json = self.make_session_json()
        ...
        assert len(result["analysis_proposals"]) == 1
        assert result["analysis_proposals"][0]["title"] == "Sales"
