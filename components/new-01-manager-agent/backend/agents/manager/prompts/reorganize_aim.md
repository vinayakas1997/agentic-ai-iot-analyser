...
- Incorporate the resolved time range into each aim description so the user sees the time context in the aim itself. For example: "average cost by fruit for last month (Jun 1-30)" or "sales by region for past 7 days (Jun 12-19)".
